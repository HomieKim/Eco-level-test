...
export const QUESTIONS: Array<QeustionType> = [
  {
    ...
    selectList: [
      {content:'최대한 강하게! 18도 파워 냉방', score:2222222},
      {content:'은은한 바람이 좋아~ 24도 1단계 바람으로 튼다'},
      {content:'절전! 에어컨보다는 선풍기지'},
      {content:'아무리 더워도 난 부채로 견딘다'},
    ],
  },
  {
    selectType: 'list',
    ...
    selectList: [
      {content:'근본은 맥도날드지! 베이컨 토마토디럭스로 간다'},
      {content:'진짜 먹잘알은 버거킹이지~ 와퍼 세트로 간다'},
      {content:'든든한 콩고기로 만든 롯데리아 리아미라클 버거로 간다'},
      {content:'햄버거보단 서브웨이 베지다!'},
    ],
  },
  {
    selectType: 'list',
    ...
    selectList: [
      {content:'귀찮은 건 딱 질색! 택시를 탄다'},
      {content:'항상 타던대로! 버스나 지하철을 탄다'},
      {content:'20분이면 걸어갈만 하지! 걸어간다'},
    ],
  },
  {
    selectType: 'list',
    ...
    selectList: [
      {content:'미리 들고온 천으로 된 장바구니를 꺼낸다'},
      {content:'쓰레기 봉투 큰 거 주세요! 새로 봉투를 사서 담아간다'},
      {content:'이럴 줄 알고 캐리어 들고 왔지! 캐리어에 담아간다.'},
    ],
  },
  {
    selectType: 'list',
    ...
    selectList: [
      {content:'평소 먹던대로 아메리카노를 시키고 플라스틱 용기에 빨대를 받아온다'},
      {content:'평소 먹던대로 아메리카노를 시키고 빨대는 필요없으니 받지 않는다'},
      {content:'평소 먹던대로 아메리카노를 시키고 텀블러에 받아온다'},
    ],
  },
  {
    selectType: 'list',
    ...
    selectList: [
      {content:'어차피 또 올거니까 방에 불을 켜놓고 나간다'},
      {content:'잠깐 나가더라도 불은 꺼야지! 방에 불을 꺼놓고 나간다'},
      {content:'방에 불을 끄고 사용하지 않는 전자 제품의 전원도 꺼놓고 나간다'},
    ],
  },
  {
    selectType: 'list',
    ...
    selectList: [
      {content:'일회용품은 안돼! 포장용기를 챙겨서 음식을 포장하러 간다'},
      {content:'설거지만 하지 뭐~ 일회용품을 받지않고 배달시킨다'},
      {content:'나가기도 귀찮고 다 귀찮아~ 일회용품 받기를 선택하고 배달시킨다'},
    ],
  },
  {
    selectType: 'ox',
